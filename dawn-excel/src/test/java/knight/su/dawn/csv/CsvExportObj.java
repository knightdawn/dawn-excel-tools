...
public class CsvExportObj implements Serializable {
	...
	public static CsvExportObj build() {
		return build(1);
	}
	
	public static CsvExportObj build(int i) {
		CsvExportObj eo = new CsvExportObj();

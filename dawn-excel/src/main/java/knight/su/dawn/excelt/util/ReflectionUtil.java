...
public class ReflectionUtil {
     ...
     * @return
     */
    public static <T> List<Field> initFields(Class<T> clazz) {
    	List<Field> fieldList = new ArrayList<>();
    	fieldList.addAll(Arrays.asList(clazz.getDeclaredFields()));
    	Class<? super T> superType = clazz.getSuperclass();
		if (Objects.nonNull(superType)) {
			fieldList.addAll(Arrays.asList(superType.getDeclaredFields()));
		}
		return fieldList;
	}
     ...
     * @return
     */
    public static <T> Constructor<T> initConstructor(Class<T> clazz) {
    	try {
